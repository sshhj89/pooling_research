...
def main():
    ...
    test_data_easy = Imagenet_ood.Imagenet_datasets(is_train=False, is_easy=True, load_mask=False, target_img_w=224,target_img_h=224, use_segmentation=True)
    test_data_hard = Imagenet_ood.Imagenet_datasets(is_train=False, is_easy=False, load_mask=False, target_img_w=224,target_img_h=224, use_segmentation=True)
